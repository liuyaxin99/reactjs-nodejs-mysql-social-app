...
const Post = ({ post }) => {
    ...
    const { isLoading: cIsLoading, error: cError, data: commentData } = useQuery(["comments", post.id], () =>
        ...
        <div className="post">
            <div className="container">
                <div className="user">
                    ...
                    {post.userId === currentUser.id && menuOpen === false && <MoreHorizIcon onClick={() => setMenuOpen(!menuOpen)} />}
